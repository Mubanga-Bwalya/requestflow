...
VALUES
  ...
  ('c1111111-1111-4111-8111-111111110002', 'Jane Employee', 'jane@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110001', 'b1111111-1111-4111-8111-111111110002', 'General Employee', TRUE),
  ('c1111111-1111-4111-8111-111111110003', 'Henry HR Manager', 'henry@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110001', 'b1111111-1111-4111-8111-111111110003', 'HR Manager', TRUE),
  ('c1111111-1111-4111-8111-111111110004', 'Mary Marketing Manager', 'mary@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110002', 'b1111111-1111-4111-8111-111111110004', 'Marketing Manager', TRUE),
  ('c1111111-1111-4111-8111-111111110005', 'Helen HR Officer', 'helen@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110001', 'b1111111-1111-4111-8111-111111110005', 'HR Officer', TRUE),
  ('c1111111-1111-4111-8111-111111110006', 'Mark Marketing Designer', 'mark@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110002', 'b1111111-1111-4111-8111-111111110006', 'Graphic Designer', TRUE),
  ('c1111111-1111-4111-8111-111111110007', 'Musa Marketing Assistant', 'musa@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
