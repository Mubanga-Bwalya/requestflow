...
-- =============================================================================
-- LIVE DB NOTE: Current demo DB may differ (Jane removed; Ivan email mbwalya4477@gmail.com).
-- This file is the source for fresh installs — do not assume it matches an existing DB.
...
-- Re-runs do NOT overwrite existing password_hash values (credentials preserved).
...
-- failed mid-transaction. In pgAdmin/psql run ROLLBACK; once manually, then re-run.
-- =============================================================================
...
VALUES
  ...
  ('c1111111-1111-4111-8111-111111110003', 'Henry', 'henry@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110001', 'b1111111-1111-4111-8111-111111110003', 'HR Manager', TRUE),
  ('c1111111-1111-4111-8111-111111110005', 'Helen', 'helen@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110001', 'b1111111-1111-4111-8111-111111110005', 'HR Officer', TRUE),
  ('c1111111-1111-4111-8111-111111110008', 'Hannah', 'hannah@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110001', 'b1111111-1111-4111-8111-111111110005', 'HR Officer', TRUE),
  ('c1111111-1111-4111-8111-111111110009', 'Hugo', 'hugo@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110001', 'b1111111-1111-4111-8111-111111110005', 'HR Officer', TRUE),
  ('c1111111-1111-4111-8111-111111110004', 'Mary', 'mary@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110002', 'b1111111-1111-4111-8111-111111110004', 'Marketing Manager', TRUE),
  ('c1111111-1111-4111-8111-111111110006', 'Mark', 'mark@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110002', 'b1111111-1111-4111-8111-111111110006', 'Marketing Designer', TRUE),
  ('c1111111-1111-4111-8111-111111110007', 'Musa', 'musa@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110002', 'b1111111-1111-4111-8111-111111110006', 'Marketing Assistant', TRUE),
  ('c1111111-1111-4111-8111-111111110010', 'Mia', 'mia@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110002', 'b1111111-1111-4111-8111-111111110006', 'Marketing Assistant', TRUE),
  ('c1111111-1111-4111-8111-111111110011', 'Ben', 'ben@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110003', 'b1111111-1111-4111-8111-111111110008', 'Billing Manager', TRUE),
  ('c1111111-1111-4111-8111-111111110012', 'Beth', 'beth@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110003', 'b1111111-1111-4111-8111-111111110009', 'Billing Officer', TRUE),
  ('c1111111-1111-4111-8111-111111110013', 'Blake', 'blake@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110003', 'b1111111-1111-4111-8111-111111110009', 'Billing Officer', TRUE),
  ('c1111111-1111-4111-8111-111111110014', 'Brooke', 'brooke@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110003', 'b1111111-1111-4111-8111-111111110009', 'Billing Officer', TRUE),
  ('c1111111-1111-4111-8111-111111110015', 'Ivan', 'mbwalya4477@gmail.com', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110004', 'b1111111-1111-4111-8111-111111110010', 'Innovations Manager', TRUE),
  ('c1111111-1111-4111-8111-111111110016', 'Iris', 'iris@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110004', 'b1111111-1111-4111-8111-111111110011', 'Innovations Analyst', TRUE),
  ('c1111111-1111-4111-8111-111111110017', 'Isaac', 'isaac@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110004', 'b1111111-1111-4111-8111-111111110011', 'Innovations Analyst', TRUE),
  ('c1111111-1111-4111-8111-111111110018', 'Imani', 'imani@requestflow.local', '$2b$10$z7FHlhnvAWYSK9tWSTbRFeKHzGKFWyDHk7jd4eFmbCU22VOWuHztK',
   'd1111111-1111-4111-8111-111111110004', 'b1111111-1111-4111-8111-111111110011', 'Innovations Analyst', TRUE)
